...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_AsymmetricKeyLengthIsLessThan1024]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_AsymmetricKeyLengthIsLessThan1024]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, IDB_MOB_ID, IDB_ID, IDB_Name, ENO_ID, ENO_Name, ENA_Name, ENO_KeyLength
