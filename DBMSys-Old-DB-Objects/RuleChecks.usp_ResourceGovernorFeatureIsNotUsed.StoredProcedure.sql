...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_ResourceGovernorFeatureIsNotUsed]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_ResourceGovernorFeatureIsNotUsed]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
if not exists (select *
				...
				where DID_IsResourceGovernorEnabled is not null
					and DID_IsResourceGovernorEnabled = 1)
