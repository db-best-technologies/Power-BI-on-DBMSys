...
GO
/****** Object:  StoredProcedure [Reports].[usp_FinancialAnalysisCloudPaaSRemainingOnPremisesTable]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [Reports].[usp_FinancialAnalysisCloudPaaSRemainingOnPremisesTable]
as
set nocount on
...
from Reports.fn_GetCostForRemainingServersForCloudDatabases(@StandardCorePrice, @EnterpriseCorePrice, @OnPremServerYearlyOperationalCostUSD, @SQLStandardEditionCoreLicensesOwned,@SQLEnterpriseEditionCoreLicensesOwned)
