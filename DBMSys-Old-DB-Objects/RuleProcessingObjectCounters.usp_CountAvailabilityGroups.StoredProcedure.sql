...
GO
/****** Object:  StoredProcedure [RuleProcessingObjectCounters].[usp_CountAvailabilityGroups]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleProcessingObjectCounters].[usp_CountAvailabilityGroups]
	@ClientID int,
	@PKN_ID int,
	@OBT_ID tinyint,
	@PLC_ID int
