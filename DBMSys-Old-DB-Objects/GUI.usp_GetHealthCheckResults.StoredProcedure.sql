...
GO
/****** Object:  StoredProcedure [GUI].[usp_GetHealthCheckResults]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [GUI].[usp_GetHealthCheckResults]
	@PackageID int = null,
...
if @PackageRunID is null
	...
	where PKT_Name = 'Health Check'
		and (PKG_ID = @PackageID
				or @PackageID is null)
	order by PKN_ID desc

select PRR_ID RuleRunID, RUL_ID RuleID, RLV_InsertDate RunDate, RLV_MOB_ID MonitoredObjectID,
