...
GO
/****** Object:  StoredProcedure [Reports].[usp_CounterGraph_Dict_Databases]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [Reports].[usp_CounterGraph_Dict_Databases]
...
select distinct IDB_Name DatabaseName
from PerformanceData.CounterCombinations
	...
	inner join Inventory.InstanceDatabases on IDB_ID = CCB_IDB_ID
union all
select ''
