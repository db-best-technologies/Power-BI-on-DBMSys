...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceUsingADynamicPort]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceUsingADynamicPort]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
where DID_IsTcpEnabled = 1
	and DID_DynamicPort is not null
GO
