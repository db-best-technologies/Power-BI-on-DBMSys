...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_IndexWithDisabledAutomaticStatisticsUpdate]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_IndexWithDisabledAutomaticStatisticsUpdate]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, PIP_MOB_ID, IDB_ID, IDB_Name, DOT_DisplayName, DSN_Name, DON_Name, DIN_Name, IDT_Name, PIP_RowCnt
