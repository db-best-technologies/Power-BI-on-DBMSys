...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_LargeTableWithNoIndexes]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_LargeTableWithNoIndexes]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, PTP_MOB_ID, IDB_ID, IDB_Name, DSN_Name, DON_Name, PTP_RowCount, PTP_TotalSizeMB
