...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_IndexingServiceIsRunning]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_IndexingServiceIsRunning]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, OSR_MOB_ID
...
where SNM_Name = 'WSearch'
	and SST_Name = 'Running'
GO
