...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceWithOleAutomationEnabled]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceWithOleAutomationEnabled]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, ICF_MOB_ID
...
where ICT_Name = 'Ole Automation Procedures'
	and ICF_Value = 1
GO
