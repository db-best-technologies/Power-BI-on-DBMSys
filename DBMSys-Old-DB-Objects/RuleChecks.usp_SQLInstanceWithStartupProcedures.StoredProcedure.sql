...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceWithStartupProcedures]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceWithStartupProcedures]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, UOS_MOB_ID, DSN_Name, DON_Name
...
where UOS_IsStartupProcedure = 1
GO
