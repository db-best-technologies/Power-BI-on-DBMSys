...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceWithoutSystemHealthXESessionRunning]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceWithoutSystemHealthXESessionRunning]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
where VER_Number >= 10
	and DID_IsSystemHealthSessionRunning is not null
	and DID_IsSystemHealthSessionRunning = 0
GO
