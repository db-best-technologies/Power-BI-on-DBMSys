...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_TempdbFilesNotEquallySized]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_TempdbFilesNotEquallySized]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
select @ClientID, @PRR_ID, IDB_MOB_ID
...
group by IDB_MOB_ID
having MAX(ResultValue) > MIN(ResultValue) + 5*1024
GO
