...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceWithADisabledRemoteDAC]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceWithADisabledRemoteDAC]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
where ICT_Name = 'remote admin connections'
	and ICF_Value = 0
GO
