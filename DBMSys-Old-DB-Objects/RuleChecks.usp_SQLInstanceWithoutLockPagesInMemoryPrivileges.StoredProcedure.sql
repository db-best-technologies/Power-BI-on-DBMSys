...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_SQLInstanceWithoutLockPagesInMemoryPrivileges]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [RuleChecks].[usp_SQLInstanceWithoutLockPagesInMemoryPrivileges]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
where DID_AllowLockPagesInMemory = 0
GO
