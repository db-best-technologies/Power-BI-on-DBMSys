...
GO
/****** Object:  StoredProcedure [GUI].[usp_Report_ServerLevelMapView]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [GUI].[usp_Report_ServerLevelMapView]
as
...
select s.MOB_Name ComputerName,
	...
	isnull(MMD_Name, 'N/A') MachineModel, OSS_InstallDate WindowsInstallationDate
from Inventory.OSServers
	inner join Inventory.MonitoredObjects s on OSS_MOB_ID = s.MOB_ID
	outer apply (select top 1 DID_InstanceName, DID_IsClustered, MOB_OOS_ID, EDT_Name, VER_Name, PRL_Name
