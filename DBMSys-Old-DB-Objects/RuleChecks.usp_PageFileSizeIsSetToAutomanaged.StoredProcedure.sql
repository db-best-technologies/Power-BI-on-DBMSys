...
GO
/****** Object:  StoredProcedure [RuleChecks].[usp_PageFileSizeIsSetToAutomanaged]    Script Date: 6/8/2020 1:14:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [RuleChecks].[usp_PageFileSizeIsSetToAutomanaged]
	@ClientID int,
	@PRR_ID int,
	@FromDate date,
	@ToDate date,
...
where OSS_IsAutomaticManagedPageFile = 1
GO
